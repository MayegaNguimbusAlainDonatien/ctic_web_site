...
const ProductSidebar = () => {
  ...
  return (
    <AppScrollbar>
      <div className={clsx(styles.productSidebar, 'position-relative')}>
        <h3 className={clsx(styles.productSidebarTitle, 'mb-2')}>Filter By</h3>

        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Categories</h5>
          {/*<ProductsCategory />*/}
        </div>
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Price</h5>
          <PriceSelector />
        </div>
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Brand</h5>
          <AppList
            data={BrandData}
            renderItem={(data) => (
              <CheckedCell
        ...
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Ideal For</h5>
          <AppList
            data={IdealFor}
            renderItem={(data) => (
              <CheckedCell
        ...
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Discount</h5>
          <AppList
            data={DiscountList}
            renderItem={(data) => (
              <CheckedCell
        ...
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Color</h5>
          <AppGrid
        ...
        <div className={clsx(styles.productSidebarItem, 'position-relative')}>
          <h5 className={styles.productSidebarItemTitle}>Customer Ratings</h5>
          <AppList
            data={[5, 4, 3, 2, 1]}
            renderItem={(data) => (
              <RatingCell
