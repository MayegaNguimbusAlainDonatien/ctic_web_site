...
import logo from '../../../assets/images/logo_ctic.png';
...
const defaultTitle = 'Canada Teaching Immigration Consulting';
  ...
  const getMetaTags = (
    {
      ...
      updated,
      category = 'CTIC',
      tags = 'we are all immigrants, it is the place of birth that changes ',
    },
    pathname,
  ) => {
